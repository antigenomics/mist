...
public class CompositePrimerSearcher {
    ...
    public CompositePrimerSearcher(PatternSearcher patternSearcherLeft,
    ...
    public CompositePrimerSearcherResult search(ReadWrapper readWrapper) {
        ...
        if (reverseAllowed && (!leftResult.isMatching() || !rightResult.isMatching())) {
            ...
            return new CompositePrimerSearcherResult(leftResult, rightResult, true);
        }

        return new CompositePrimerSearcherResult(leftResult, rightResult, false);
    }
}
