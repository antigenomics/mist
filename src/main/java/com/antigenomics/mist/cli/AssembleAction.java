...
public class AssembleAction implements Action {
    public static final String OUTPUT_SUFFIX = "asm",
            DISCARDED_SUFFIX = "asm" + SUFFIX_SEP + "bad";

    final AssemblerParameters actionParameters = new AssemblerParameters();
    ...
    public static final class AssemblerParameters extends ActionParameters {
        @Parameter(description = CorrectAction.OUTPUT_SUFFIX + MistCLIUtil.SUFFIX_SEP + "R1.fastq[.gz] " +
                "[" + CorrectAction.OUTPUT_SUFFIX + MistCLIUtil.SUFFIX_SEP + "R2.fastq[.gz]]",
                variableArity = true)
